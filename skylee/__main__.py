...
Any issues or need help related to me? join our group [HELP](https://t.me/Giveaways_Nation).
...
buttons = [
    [
        InlineKeyboardButton(
            text="Add to Group 👥", url="t.me/Keyss007_bot?startgroup=true"
        ),
        InlineKeyboardButton(text="Updates 📢", url="https://t.me/Keyss007_bot"),
    ]
]
